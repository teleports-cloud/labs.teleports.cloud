      ...
      <div className="absolute top-4 right-4 flex flex-row items-center gap-2 z-10">
        ...
        <div className="flex items-center gap-1">
          <a href="https://github.com/teleports-cloud/labs.teleports.cloud/commits/main" target="_blank" rel="noopener noreferrer">
            <img src={`https://img.shields.io/badge/stamped-${stampedCommitHash}-black?style=flat&logo=github`} alt="Stamped Commit" />
          </a>
          <span>&gt;</span>
          <a href="https://github.com/teleports-cloud/labs.teleports.cloud/commits/main" target="_blank" rel="noopener noreferrer">
            <img src={`https://img.shields.io/badge/latest-${latestCommitHash}-black?style=flat`} alt="Latest Commit" />
          </a>
